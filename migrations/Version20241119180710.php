 ...
 */
final class Version20241119180710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE developer (id INT NOT NULL, full_name VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, age INT NOT NULL, salary INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, name VARCHAR(255) NOT NULL, customer VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
